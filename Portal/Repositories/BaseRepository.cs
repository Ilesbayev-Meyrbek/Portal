...
namespace Portal.Repositories
{
    ...
    public abstract class BaseScaleRepository<T> : IBaseRepository<T> where T : class
    {
        private readonly ScaleContext _db;

        protected BaseScaleRepository(ScaleContext db)
        {
            _db = db;
        }
